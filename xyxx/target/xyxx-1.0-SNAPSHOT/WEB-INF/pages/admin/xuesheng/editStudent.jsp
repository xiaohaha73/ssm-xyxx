...
<script language="javascript">
    function checkDo(){
        ...
        form.action="<%=request.getContextPath()%>/admin/editstudent";
        form.submit();
    }
</script>
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" method="post"  name="form" action="<%=request.getContextPath()%>/admin/editstudent">
