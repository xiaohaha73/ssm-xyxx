                            ...
                            <table id="table1" class="table table-striped table-bordered table-hover">
                                ...
                                <c:forEach items="${list}" var="mymap" varStatus="status">
                                    <tr>
                                        ...
                                        <td><div class="hidden-sm hidden-xs btn-group"><a href="<%= request.getContextPath()%>/common/delkcb?keyid=${mymap.kcbid}"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}" class="btn btn-xs btn-danger">删除</a>
                                            <a href="<%= request.getContextPath()%>/common/editkcb?keyid=${mymap.kcbid}"  class="btn btn-xs btn-success"  >修改</a><a href="<%= request.getContextPath()%>/common/kcbdetail?keyid=${mymap.kcbid}"    class="btn btn-xs btn-info" >详情</a></div></td>
                                    </tr>
