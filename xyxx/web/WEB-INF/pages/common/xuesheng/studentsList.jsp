  ...
  <div class="main-content">
    ...
    <div class="page-content">
      ...
      <div class="page-content-area">
        ...
        <div class="row">
          <div class="col-xs-12">
            <form name="form" method="post" action="<%=request.getContextPath()%>/xuesheng/listpage">
              ...
              <table id="table1" class="table table-striped table-bordered table-hover">
                ...
                <c:forEach items="${list}" var="mymap" varStatus="status">
                  <tr>
                    ...
                    <td><div class="hidden-sm hidden-xs btn-group"><a href="<%= request.getContextPath()%>/common/delstudent?keyid=${mymap.xsid}"  onClick="javascript:if(confirm('是否删除')){return true;} else{return false;}" class="btn btn-xs btn-danger">删除</a>
                      <a href="<%= request.getContextPath()%>/common/editstupage?keyid=${mymap.xsid}"  class="btn btn-xs btn-success"  >修改</a><a href="<%= request.getContextPath()%>/common/studentdetail?keyid=${mymap.xsid}"    class="btn btn-xs btn-info" >详情</a></div></td>
                  </tr>
