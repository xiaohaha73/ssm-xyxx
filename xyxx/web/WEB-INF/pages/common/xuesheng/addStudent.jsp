...
<script language="javascript">
    function checkDo(){
        ...
        form.action="<%=request.getContextPath()%>/common/addstudent";
        form.submit();
    }
</script>
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" method="post"  role="form" name="form" action="<%=request.getContextPath()%>/common/addstudent">
